function bat_kolmgolov_entropy
...
for j=1:n
  ...
  for trial=1:39
       channel=size(Data,1);
    for i=1:channel
        Km(trial,i)=kolmgolov_entropy(Data(i,:)); 
    end
  end
        ...
        id2 = id2';
        Km1 = [id2,Km];
   finalFeatures = [finalFeatures;Km1];
end
save([dir_out 'KOL'],'finalFeatures');
xlswrite([dir_out,'KOL','.xlsx'], finalFeatures);
